 ...
 * @generated
 */
public class EntityProspectionServiceClpInvoker {
    private String _methodName198;
    private String[] _methodParameterTypes198;
    private String _methodName199;
    private String[] _methodParameterTypes199;

    public EntityProspectionServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName198.equals(name) &&
            ...
            return EntityProspectionServiceUtil.getBeanIdentifier();
        }

        if (_methodName199.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes199, parameterTypes)) {
            EntityProspectionServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
