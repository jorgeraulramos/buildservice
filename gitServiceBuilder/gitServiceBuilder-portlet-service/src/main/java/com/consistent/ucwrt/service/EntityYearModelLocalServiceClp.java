 ...
 * @generated
 */
public class EntityYearModelLocalServiceClp
    ...
    public EntityYearModelLocalServiceClp(
    ...
    public com.consistent.ucwrt.model.EntityYearModel addEntityYearModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(entityYearModel) });
        } catch (Throwable t) {
        ...
        return (com.consistent.ucwrt.model.EntityYearModel) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.consistent.ucwrt.model.EntityYearModel createEntityYearModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { yearModel });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityYearModel deleteEntityYearModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { yearModel });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityYearModel fetchEntityYearModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { yearModel });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityYearModel getEntityYearModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { yearModel });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.consistent.ucwrt.model.EntityYearModel> getEntityYearModels(
        ...
        return (java.util.List<com.consistent.ucwrt.model.EntityYearModel>) ClpSerializer.translateOutput(returnObj);
    }
