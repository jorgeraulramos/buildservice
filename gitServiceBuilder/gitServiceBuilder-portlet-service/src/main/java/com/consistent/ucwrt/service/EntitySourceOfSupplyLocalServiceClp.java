 ...
 * @generated
 */
public class EntitySourceOfSupplyLocalServiceClp
    ...
    public EntitySourceOfSupplyLocalServiceClp(
    ...
    public com.consistent.ucwrt.model.EntitySourceOfSupply addEntitySourceOfSupply(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(entitySourceOfSupply)
                    });
        } catch (Throwable t) {
        ...
        return (com.consistent.ucwrt.model.EntitySourceOfSupply) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.consistent.ucwrt.model.EntitySourceOfSupply createEntitySourceOfSupply(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { sourceSupplyId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntitySourceOfSupply deleteEntitySourceOfSupply(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { sourceSupplyId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntitySourceOfSupply fetchEntitySourceOfSupply(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { sourceSupplyId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntitySourceOfSupply getEntitySourceOfSupply(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { sourceSupplyId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.consistent.ucwrt.model.EntitySourceOfSupply> getEntitySourceOfSupplies(
        ...
        return (java.util.List<com.consistent.ucwrt.model.EntitySourceOfSupply>) ClpSerializer.translateOutput(returnObj);
    }
