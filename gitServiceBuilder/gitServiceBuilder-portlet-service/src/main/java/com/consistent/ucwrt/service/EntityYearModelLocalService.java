...
/**
 * Provides the local service interface for EntityYearModel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EntityYearModelLocalServiceUtil
...
public interface EntityYearModelLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EntityYearModelLocalServiceUtil} to access the entity year model local service. Add custom service methods to {@link com.consistent.ucwrt.service.impl.EntityYearModelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
