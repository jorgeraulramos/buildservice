 ...
 * @generated
 */
public class EntityProspectionLocalServiceClp
    ...
    public EntityProspectionLocalServiceClp(
    ...
    public com.consistent.ucwrt.model.EntityProspection addEntityProspection(
        ...
        return (com.consistent.ucwrt.model.EntityProspection) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.consistent.ucwrt.model.EntityProspection createEntityProspection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { prospectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityProspection deleteEntityProspection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { prospectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityProspection fetchEntityProspection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { prospectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.consistent.ucwrt.model.EntityProspection getEntityProspection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { prospectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.consistent.ucwrt.model.EntityProspection> getEntityProspections(
        ...
        return (java.util.List<com.consistent.ucwrt.model.EntityProspection>) ClpSerializer.translateOutput(returnObj);
    }
