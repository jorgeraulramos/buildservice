 ...
 * @generated
 */
public class EntityYearModelClassLocalServiceClp
    ...
    public EntityYearModelClassLocalServiceClp(
    ...
    public com.consistent.ucwrt.model.EntityYearModelClass addEntityYearModelClass(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(entityYearModelClass)
                    });
        } catch (Throwable t) {
        ...
        return (com.consistent.ucwrt.model.EntityYearModelClass) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.consistent.ucwrt.model.EntityYearModelClass createEntityYearModelClass(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(entityYearModelClassPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.consistent.ucwrt.model.EntityYearModelClass> getEntityYearModelClasses(
        ...
        return (java.util.List<com.consistent.ucwrt.model.EntityYearModelClass>) ClpSerializer.translateOutput(returnObj);
    }
