...
/**
 * Provides the local service interface for EntityDealer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EntityDealerLocalServiceUtil
...
public interface EntityDealerLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EntityDealerLocalServiceUtil} to access the entity dealer local service. Add custom service methods to {@link com.consistent.ucwrt.service.impl.EntityDealerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
